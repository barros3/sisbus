...
<template:admin>
            ...
            <nav class="nav-breadcrumb">
                <div class="nav-wrapper">
                    <div class="col s12">
                        ...
                        <a href="#!" class="breadcrumb">Atualizar administrador</a>
                    </div>
                </div>
            </nav>
        </div>
 ...
 <div class="panel panel-primary" style='width: 40%; margin-left: auto ; margin-right: auto ; margin-top:0; margin-bottom:0;'>
	<div class="panel-heading">
      ...
      <form:form role="form" cssClass="well" commandName="administrador" servletRelativeAction="/admin_master/administrador/${administrador.id}" method="POST" >
