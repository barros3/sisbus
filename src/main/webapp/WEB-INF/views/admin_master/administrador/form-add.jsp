...
<div class="panel panel-primary" style='width: 40%; margin-left: auto ; margin-right: auto ; margin-top:0; margin-bottom:0;'>
	<div class="panel-heading">
		<h1 class="panel-title">Cadastro de Administradores</h1>
	</div>
		<div class="panel-body">
      <form:form role="form" cssClass="well" commandName="administrador" servletRelativeAction="/admin_master/administrador" method="POST" >
