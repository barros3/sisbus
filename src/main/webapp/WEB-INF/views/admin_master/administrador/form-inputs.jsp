...
<div class="form-group">
	...
	<form:input path='usuario.login' type='text' class="form-control" placeholder="Exemplo!123" required="required" pattern=".{0,20}" title="Esse campo não pode ultrapassar mais de 20 caracteres"/>
...
<div class="form-group">
	...
	<form:input path='usuario.senha' type='password' class="form-control" maxlength="20" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,20}" title="A senha deve conter no mínimo 8 caracteres e deve conter pelo menos um número, uma letra maiúscula e uma minúscula e não pode ultrapasar mais de 20 caracteres" placeholder='Ex: Abc@1234' required="required" />
